 ...
 */
export function personalAccessTokensAdminRevokePersonalAccessToken(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AdminRevokePersonalAccessTokenRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/personal-access-tokens/admin/{tokenId}")(
    pathParams,
  );
