...
export function agentsUploadAgentConversationChatAttachments(
  ...
  Result<
    models.ChatAttachmentUploadResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UploadAgentConversationChatAttachmentsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ChatAttachmentUploadResponse$inboundSchema),
