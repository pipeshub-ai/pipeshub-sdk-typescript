...
export function agentsDeleteAgentConversationChatAttachment(
  ...
  Result<
    void,
    | errors.DeleteAgentConversationChatAttachmentBadRequestError
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteAgentConversationChatAttachmentRequest$outboundSchema,
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.DeleteAgentConversationChatAttachmentBadRequestError$inboundSchema,
    ),
    M.fail([401, 403, "4XX"]),
    M.fail("5XX"),
