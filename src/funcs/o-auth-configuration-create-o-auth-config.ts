...
export function oAuthConfigurationCreateOAuthConfig(
  ...
  Result<
    operations.CreateOAuthConfigResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateOAuthConfigRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateOAuthConfigResponse$inboundSchema),
