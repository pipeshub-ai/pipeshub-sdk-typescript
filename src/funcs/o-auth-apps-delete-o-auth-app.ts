...
export function oAuthAppsDeleteOAuthApp(
  ...
  Result<
    operations.DeleteOAuthAppResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteOAuthAppRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteOAuthAppResponse$inboundSchema),
    M.jsonErr(
      [401, 403, 404],
