...
| `security`                                                                                                                                                                     | [operations.DownloadDocumentSecurity](../../models/operations/download-document-security.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
