...
export class ConnectorInstances extends ClientSDK {
  ...
  async listConnectorInstances(
    security: operations.ListConnectorInstancesSecurity,
  ...
  async createConnectorInstance(
    security: operations.CreateConnectorInstanceSecurity,
  ...
  async listActiveConnectors(
    security: operations.ListActiveConnectorsSecurity,
    options?: RequestOptions,
  ...
  async listInactiveConnectors(
    security: operations.ListInactiveConnectorsSecurity,
    options?: RequestOptions,
  ...
  async listConfiguredConnectors(
    security: operations.ListConfiguredConnectorsSecurity,
  ...
  async listActiveAgentConnectors(
    security: operations.ListActiveAgentConnectorsSecurity,
  ...
  async getConnectorInstance(
    security: operations.GetConnectorInstanceSecurity,
  ...
  async deleteConnectorInstance(
    security: operations.DeleteConnectorInstanceSecurity,
  ...
  async updateConnectorName(
    security: operations.UpdateConnectorNameSecurity,
