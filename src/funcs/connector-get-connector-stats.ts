...
export function connectorGetConnectorStats(
  client: PipeshubCore,
  security: operations.GetConnectorStatsSecurity,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetConnectorStatsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ConnectorStats$inboundSchema),
    M.fail([401, 404, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
