...
export function userGroupsAddUsersToGroup(
  ...
  Result<
    operations.AddUsersToGroupResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.AddUsersToGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AddUsersToGroupResponse$inboundSchema),
