...
export function knowledgeBasesDeleteKnowledgeBase(
  ...
  Result<
    operations.DeleteKnowledgeBaseResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteKnowledgeBaseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteKnowledgeBaseResponse$inboundSchema),
