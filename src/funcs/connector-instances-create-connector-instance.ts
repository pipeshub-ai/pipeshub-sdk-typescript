...
export function connectorInstancesCreateConnectorInstance(
  ...
  Result<
    operations.CreateConnectorInstanceResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateConnectorRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateConnectorInstanceResponse$inboundSchema),
