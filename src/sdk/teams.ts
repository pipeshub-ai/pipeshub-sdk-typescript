...
import { teamsAddUsersToTeam } from "../funcs/teams-add-users-to-team.js";
...
import { teamsGetTeamUsers } from "../funcs/teams-get-team-users.js";
import { teamsGetUserCreatedTeams } from "../funcs/teams-get-user-created-teams.js";
import { teamsGetUserTeams } from "../funcs/teams-get-user-teams.js";
import { teamsListTeams } from "../funcs/teams-list-teams.js";
import { teamsRemoveUserFromTeam } from "../funcs/teams-remove-user-from-team.js";
import { teamsUpdateTeamUsersPermissions } from "../funcs/teams-update-team-users-permissions.js";
...
export class Teams extends ClientSDK {
  ...
  async getTeamUsers(
    ...
    return unwrapAsync(teamsGetTeamUsers(
      this,
      request,
      options,
    ));
  ...
  async addUsersToTeam(
    ...
    return unwrapAsync(teamsAddUsersToTeam(
      this,
      request,
      options,
    ));
  ...
  async removeUserFromTeam(
    ...
    options?: RequestOptions,
  ): Promise<operations.RemoveUserFromTeamResponse> {
    return unwrapAsync(teamsRemoveUserFromTeam(
      this,
      request,
      options,
    ));
  ...
  async updateTeamUsersPermissions(
    ...
    options?: RequestOptions,
  ): Promise<operations.UpdateTeamUsersPermissionsResponse> {
    return unwrapAsync(teamsUpdateTeamUsersPermissions(
      this,
      request,
      options,
    ));
  ...
  async getUserCreatedTeams(
    ...
    return unwrapAsync(teamsGetUserCreatedTeams(
      this,
      options,
    ));
  }
