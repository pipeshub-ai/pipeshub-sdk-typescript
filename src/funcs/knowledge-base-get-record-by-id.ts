 ...
 */
export function knowledgeBaseGetRecordById(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetRecordByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetRecordByIdResponseSchema$inboundSchema),
