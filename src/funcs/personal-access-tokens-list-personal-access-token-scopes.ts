 ...
 */
export function personalAccessTokensListPersonalAccessTokenScopes(
  client: PipeshubCore,
...
> {
  const path = pathToFunc("/personal-access-tokens/scopes")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PatScopesListResponse$inboundSchema),
