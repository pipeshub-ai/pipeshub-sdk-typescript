...
export function connectorConfigurationUpdateConnectorFiltersSyncConfig(
  client: PipeshubCore,
  security: operations.UpdateConnectorFiltersSyncConfigSecurity,
  request: operations.UpdateConnectorFiltersSyncConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateConnectorFiltersSyncConfigResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateConnectorFiltersSyncConfigRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.UpdateConnectorFiltersSyncConfigResponse$inboundSchema,
    ),
    M.fail([401, 404, "4XX"]),
    M.fail("5XX"),
  )(response, req);
