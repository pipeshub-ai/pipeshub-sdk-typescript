 ...
 */
export function knowledgeBaseGetKnowledgeBase(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetKnowledgeBaseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetKnowledgeBaseById$inboundSchema),
