...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.AdminListPersonalAccessTokensRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/personal-access-tokens/admin")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AdminPatListResponse$inboundSchema),
