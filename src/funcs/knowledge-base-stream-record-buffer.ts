 ...
 */
export function knowledgeBaseStreamRecordBuffer(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.StreamRecordBufferRequest$outboundSchema, value),
  ...
  >(
    ...
    M.jsonErr([404, 409], errors.StreamRecordErrorResponse$inboundSchema),
    M.jsonErr(500, errors.StreamRecordErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
