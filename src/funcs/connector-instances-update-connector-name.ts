...
export function connectorInstancesUpdateConnectorName(
  ...
  Result<
    operations.UpdateConnectorNameResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateConnectorNameRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateConnectorNameResponse$inboundSchema),
