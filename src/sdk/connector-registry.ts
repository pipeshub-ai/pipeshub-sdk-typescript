...
import { connectorRegistryGetConnectorRegistry } from "../funcs/connector-registry-get-connector-registry.js";
import { connectorRegistryGetConnectorSchema } from "../funcs/connector-registry-get-connector-schema.js";
...
export class ConnectorRegistry extends ClientSDK {
   ...
   */
  async getConnectorRegistry(
    security: operations.GetConnectorRegistrySecurity,
    request?: operations.GetConnectorRegistryRequest | undefined,
    options?: RequestOptions,
  ): Promise<operations.GetConnectorRegistryResponse> {
    return unwrapAsync(connectorRegistryGetConnectorRegistry(
      this,
      security,
      request,
      options,
  ...
  async getConnectorSchema(
    security: operations.GetConnectorSchemaSecurity,
    request: operations.GetConnectorSchemaRequest,
    options?: RequestOptions,
  ): Promise<operations.GetConnectorSchemaResponse> {
    return unwrapAsync(connectorRegistryGetConnectorSchema(
      this,
      security,
      request,
      options,
