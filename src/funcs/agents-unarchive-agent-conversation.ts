...
export function agentsUnarchiveAgentConversation(
  ...
  Result<
    models.AgentConversationUnarchiveResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UnarchiveAgentConversationRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentConversationUnarchiveResponse$inboundSchema),
