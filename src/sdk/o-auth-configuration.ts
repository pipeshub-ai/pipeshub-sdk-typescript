...
import { oAuthConfigurationDeleteToolsetOAuthConfig } from "../funcs/o-auth-configuration-delete-toolset-o-auth-config.js";
...
import { oAuthConfigurationListToolsetOAuthConfigs } from "../funcs/o-auth-configuration-list-toolset-o-auth-configs.js";
import { oAuthConfigurationUpdateOAuthConfig } from "../funcs/o-auth-configuration-update-o-auth-config.js";
import { oAuthConfigurationUpdateToolsetOAuthConfig } from "../funcs/o-auth-configuration-update-toolset-o-auth-config.js";
...
export class OAuthConfiguration extends ClientSDK {
   ...
   */
  async listToolsetOAuthConfigs(
    request: operations.ListToolsetOAuthConfigsRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(oAuthConfigurationListToolsetOAuthConfigs(
      this,
      request,
      options,
    ));
   ...
   * Update OAuth config
   */
  async updateToolsetOAuthConfig(
    request: operations.UpdateToolsetOAuthConfigRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(oAuthConfigurationUpdateToolsetOAuthConfig(
      this,
      request,
      options,
    ));
   ...
   * Delete OAuth config
   */
  async deleteToolsetOAuthConfig(
    request: operations.DeleteToolsetOAuthConfigRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(oAuthConfigurationDeleteToolsetOAuthConfig(
      this,
      request,
      options,
    ));
