...
export function oAuthProviderOauthAuthorizeConsent(
  ...
  Result<
    operations.OauthAuthorizeConsentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.OAuthConsentRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.OauthAuthorizeConsentResponse$inboundSchema),
