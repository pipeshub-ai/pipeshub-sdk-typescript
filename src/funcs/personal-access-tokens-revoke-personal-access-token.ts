 ...
 * flight.
 */
export function personalAccessTokensRevokePersonalAccessToken(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.RevokePersonalAccessTokenRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/personal-access-tokens/{tokenId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RevokePatResponse$inboundSchema),
    M.jsonErr([401, 404], errors.ApplicationJsonErrorResponse$inboundSchema),
