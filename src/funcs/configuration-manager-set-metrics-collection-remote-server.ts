...
export function configurationManagerSetMetricsCollectionRemoteServer(
  ...
  Result<
    operations.SetMetricsCollectionRemoteServerResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetMetricsCollectionRemoteServerRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SetMetricsCollectionRemoteServerResponse$inboundSchema,
    ),
    M.fail([401, 403, "4XX"]),
    M.fail("5XX"),
  )(response, req);
