...
export function connectorInstancesGetConnectorInstance(
  ...
  Result<
    operations.GetConnectorInstanceResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetConnectorInstanceRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetConnectorInstanceResponse$inboundSchema),
