...
export function connectorConfigurationUpdateConnectorAuthConfig(
  client: PipeshubCore,
  security: operations.UpdateConnectorAuthConfigSecurity,
  request: operations.UpdateConnectorAuthConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateConnectorAuthConfigResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateConnectorAuthConfigRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateConnectorAuthConfigResponse$inboundSchema),
