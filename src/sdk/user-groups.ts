...
import { userGroupsGetGroupStatistics } from "../funcs/user-groups-get-group-statistics.js";
...
import { userGroupsGetUsersInGroup } from "../funcs/user-groups-get-users-in-group.js";
...
export class UserGroups extends ClientSDK {
  ...
  async getUsersInGroup(
    ...
    return unwrapAsync(userGroupsGetUsersInGroup(
      this,
      request,
      options,
    ));
  ...
  async getGroupStatistics(
    options?: RequestOptions,
  ): Promise<operations.GetGroupStatisticsResponse> {
    return unwrapAsync(userGroupsGetGroupStatistics(
      this,
      options,
    ));
  }
