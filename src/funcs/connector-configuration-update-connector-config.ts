...
export function connectorConfigurationUpdateConnectorConfig(
  client: PipeshubCore,
  security: operations.UpdateConnectorConfigSecurity,
  request: operations.UpdateConnectorConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateConnectorConfigResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateConnectorConfigRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateConnectorConfigResponse$inboundSchema),
