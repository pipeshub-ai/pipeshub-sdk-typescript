...
export function agentsArchiveAgentConversation(
  ...
  Result<
    models.AgentConversationArchiveResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ArchiveAgentConversationRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentConversationArchiveResponse$inboundSchema),
