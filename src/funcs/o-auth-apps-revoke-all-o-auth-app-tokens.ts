...
export function oAuthAppsRevokeAllOAuthAppTokens(
  ...
  Result<
    operations.RevokeAllOAuthAppTokensResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RevokeAllOAuthAppTokensRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RevokeAllOAuthAppTokensResponse$inboundSchema),
    M.jsonErr(
      [401, 403, 404],
