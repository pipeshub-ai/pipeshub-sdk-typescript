...
```typescript
import { AssistantMessageStreamSSEEvent } from "@pipeshub-ai/sdk/models";

let value: AssistantMessageStreamSSEEvent = {};
```
...
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `event`                                                                                             | [models.AssistantMessageStreamSSEEventEvent](../models/assistant-message-stream-sse-event-event.md) | :heavy_minus_sign:                                                                                  | N/A                                                                                                 |
