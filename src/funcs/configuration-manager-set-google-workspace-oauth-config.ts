...
export function configurationManagerSetGoogleWorkspaceOauthConfig(
  client: PipeshubCore,
  _request: operations.SetGoogleWorkspaceOauthConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetGoogleWorkspaceOauthConfigResponse,
    | PipeshubError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SetGoogleWorkspaceOauthConfigResponse$inboundSchema),
    M.fail([401, 403, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
