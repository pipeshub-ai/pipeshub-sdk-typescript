...
export function agentsDeleteAgentConversationById(
  ...
  Result<
    models.AgentConversationDeleteResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteAgentConversationByIdRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentConversationDeleteResponse$inboundSchema),
