 ...
 */
export function knowledgeBaseDeleteRecord(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteRecordRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteRecordResponseSchema$inboundSchema),
