...
import { connectorOAuthGetOAuthAuthorizationUrl } from "pipeshub/funcs/connector-o-auth-get-o-auth-authorization-url.js";
...
| `security`                                                                                                                                                                     | [operations.GetOAuthAuthorizationUrlSecurity](../../models/operations/get-o-auth-authorization-url-security.md)                                                                | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
...
```typescript
import { PipeshubCore } from "pipeshub/core.js";
import { connectorOAuthHandleOAuthCallback } from "pipeshub/funcs/connector-o-auth-handle-o-auth-callback.js";
