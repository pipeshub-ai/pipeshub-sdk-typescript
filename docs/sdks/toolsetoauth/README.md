...
* [getInstanceOAuthAuthorizationUrl](#getinstanceoauthauthorizationurl) - Get OAuth authorization URL for instance
...
import { toolsetOAuthGetToolsetOAuthUrl } from "@pipeshub-ai/sdk/funcs/toolset-o-auth-get-toolset-o-auth-url.js";
...
```typescript
import { PipeshubCore } from "@pipeshub-ai/sdk/core.js";
import { toolsetOAuthHandleToolsetOAuthCallback } from "@pipeshub-ai/sdk/funcs/toolset-o-auth-handle-toolset-o-auth-callback.js";
...
<!-- UsageSnippet language="typescript" operationID="getInstanceOAuthAuthorizationUrl" method="get" path="/toolsets/instances/{instanceId}/oauth/authorize" -->
```typescript
import { Pipeshub } from "@pipeshub-ai/sdk";
...
async function run() {
  const result = await pipeshub.toolsetOAuth.getInstanceOAuthAuthorizationUrl({
    instanceId: "<id>",
  });
...
```typescript
import { PipeshubCore } from "@pipeshub-ai/sdk/core.js";
import { toolsetOAuthGetInstanceOAuthAuthorizationUrl } from "@pipeshub-ai/sdk/funcs/toolset-o-auth-get-instance-o-auth-authorization-url.js";
...
async function run() {
  const res = await toolsetOAuthGetInstanceOAuthAuthorizationUrl(pipeshub, {
    instanceId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("toolsetOAuthGetInstanceOAuthAuthorizationUrl failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetInstanceOAuthAuthorizationUrlRequest](../../models/operations/get-instance-o-auth-authorization-url-request.md)                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetInstanceOAuthAuthorizationUrlResponse](../../models/operations/get-instance-o-auth-authorization-url-response.md)\>**
