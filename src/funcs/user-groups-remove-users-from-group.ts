...
export function userGroupsRemoveUsersFromGroup(
  ...
  Result<
    operations.RemoveUsersFromGroupResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RemoveUsersFromGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RemoveUsersFromGroupResponse$inboundSchema),
