 ...
 */
export function knowledgeBaseReindexRecordGroup(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ReindexRecordGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReIndexRecordGroupResponseSchema$inboundSchema),
