 ...
 */
export function knowledgeBaseUpdateKnowledgeBase(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateKnowledgeBaseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateKnowledgeBaseById$inboundSchema),
