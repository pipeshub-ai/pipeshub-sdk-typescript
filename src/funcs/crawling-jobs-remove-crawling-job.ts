...
export function crawlingJobsRemoveCrawlingJob(
  client: PipeshubCore,
  security: operations.RemoveCrawlingJobSecurity,
  request: operations.RemoveCrawlingJobRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RemoveCrawlingJobResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RemoveCrawlingJobRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RemoveCrawlingJobResponse$inboundSchema),
