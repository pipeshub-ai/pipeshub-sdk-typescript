...
import { crawlingJobsGetAllCrawlingJobStatus } from "../funcs/crawling-jobs-get-all-crawling-job-status.js";
import { crawlingJobsGetCrawlingJobStatus } from "../funcs/crawling-jobs-get-crawling-job-status.js";
import { crawlingJobsGetQueueStats } from "../funcs/crawling-jobs-get-queue-stats.js";
import { crawlingJobsPauseCrawlingJob } from "../funcs/crawling-jobs-pause-crawling-job.js";
import { crawlingJobsRemoveAllCrawlingJob } from "../funcs/crawling-jobs-remove-all-crawling-job.js";
import { crawlingJobsRemoveCrawlingJob } from "../funcs/crawling-jobs-remove-crawling-job.js";
import { crawlingJobsResumeCrawlingJob } from "../funcs/crawling-jobs-resume-crawling-job.js";
...
export class CrawlingJobs extends ClientSDK {
  ...
  async getAllCrawlingJobStatus(
    ...
    return unwrapAsync(crawlingJobsGetAllCrawlingJobStatus(
      this,
      options,
    ));
  }
  ...
  async removeAllCrawlingJob(
    options?: RequestOptions,
  ): Promise<operations.RemoveAllCrawlingJobResponse> {
    return unwrapAsync(crawlingJobsRemoveAllCrawlingJob(
      this,
      options,
    ));
  }
  ...
  async pauseCrawlingJob(
    ...
    return unwrapAsync(crawlingJobsPauseCrawlingJob(
      this,
      request,
      options,
    ));
  ...
  async resumeCrawlingJob(
    ...
    return unwrapAsync(crawlingJobsResumeCrawlingJob(
      this,
      request,
      options,
    ));
  ...
  async getQueueStats(
    ...
    return unwrapAsync(crawlingJobsGetQueueStats(
      this,
      options,
    ));
  }
