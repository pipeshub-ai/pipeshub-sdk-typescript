...
export function agentsUpdateAgentConversationTitle(
  ...
  Result<
    models.AgentConversationTitleUpdateResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateAgentConversationTitleRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AgentConversationTitleUpdateResponse$inboundSchema),
