...
export function metricsCollectionToggleMetricsCollection(
  client: PipeshubCore,
  security: operations.ToggleMetricsCollectionSecurity,
  request: operations.ToggleMetricsCollectionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToggleMetricsCollectionResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ToggleMetricsCollectionRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToggleMetricsCollectionResponse$inboundSchema),
