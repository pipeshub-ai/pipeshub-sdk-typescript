...
export const AssistantMessageStreamSSEEventEvent = {
  Connected: "connected",
  Status: "status",
...
export type AssistantMessageStreamSSEEventEvent = OpenEnum<
  typeof AssistantMessageStreamSSEEventEvent
>;
 ...
 * as errors.
 */
export type AssistantMessageStreamSSEEvent = {
  event?: AssistantMessageStreamSSEEventEvent | undefined;
  /**
...
/** @internal */
export const AssistantMessageStreamSSEEventEvent$inboundSchema: z.ZodMiniType<
  AssistantMessageStreamSSEEventEvent,
  unknown
> = openEnums.inboundSchema(AssistantMessageStreamSSEEventEvent);

/** @internal */
export const AssistantMessageStreamSSEEvent$inboundSchema: z.ZodMiniType<
  AssistantMessageStreamSSEEvent,
  unknown
> = z.object({
  event: types.optional(AssistantMessageStreamSSEEventEvent$inboundSchema),
  data: types.optional(types.string()),
});

export function assistantMessageStreamSSEEventFromJSON(
  jsonString: string,
): SafeParseResult<AssistantMessageStreamSSEEvent, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AssistantMessageStreamSSEEvent$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AssistantMessageStreamSSEEvent' from JSON`,
  );
}
