...
import { organizationsCheckOrgExists } from "../funcs/organizations-check-org-exists.js";
import { organizationsCreateOrganization } from "../funcs/organizations-create-organization.js";
import { organizationsDeleteOrganizationLogo } from "../funcs/organizations-delete-organization-logo.js";
...
import { organizationsGetOrganizationLogo } from "../funcs/organizations-get-organization-logo.js";
...
import { organizationsUploadOrganizationLogo } from "../funcs/organizations-upload-organization-logo.js";
...
export class Organizations extends ClientSDK {
  ...
  async checkOrgExists(
    ...
    return unwrapAsync(organizationsCheckOrgExists(
      this,
      options,
    ));
  }
  ...
  async getCurrentOrganization(
    security: operations.GetCurrentOrganizationSecurity,
    options?: RequestOptions,
  ...
  async uploadOrganizationLogo(
    security: operations.UploadOrganizationLogoSecurity,
    request: operations.UploadOrganizationLogoRequest,
    options?: RequestOptions,
  ): Promise<operations.UploadOrganizationLogoResponse> {
    return unwrapAsync(organizationsUploadOrganizationLogo(
      this,
      security,
      request,
      options,
  ...
  async getOrganizationLogo(
    security: operations.GetOrganizationLogoSecurity,
    options?: RequestOptions,
  ): Promise<operations.GetOrganizationLogoResponse> {
    return unwrapAsync(organizationsGetOrganizationLogo(
      this,
      security,
      options,
    ));
  ...
  async deleteOrganizationLogo(
    security: operations.DeleteOrganizationLogoSecurity,
    options?: RequestOptions,
  ): Promise<operations.DeleteOrganizationLogoResponse> {
    return unwrapAsync(organizationsDeleteOrganizationLogo(
      this,
      security,
      options,
    ));
