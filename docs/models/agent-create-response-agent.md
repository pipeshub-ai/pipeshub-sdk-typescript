...
| `defaultReasoningEffort`                                                                                                   | [models.AgentCreateResponseAgentDefaultReasoningEffort](../models/agent-create-response-agent-default-reasoning-effort.md) | :heavy_minus_sign:                                                                                                         | Agent-level reasoning effort used when a chat request omits its own. Null when unset.                                      |
...
| `mcpServers`                                                                                                               | [models.AgentCreateResponseMcpServer](../models/agent-create-response-mcp-server.md)[]                                     | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `knowledge`                                                                                                                | [models.AgentCreateResponseKnowledge](../models/agent-create-response-knowledge.md)[]                                      | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |
| `skills`                                                                                                                   | [models.AgentCreateResponseSkill](../models/agent-create-response-skill.md)[]                                              | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |