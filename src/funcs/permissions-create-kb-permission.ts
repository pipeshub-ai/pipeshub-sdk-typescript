...
export function permissionsCreateKBPermission(
  ...
  Result<
    operations.CreateKBPermissionResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateKBPermissionRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateKBPermissionResponse$inboundSchema),
