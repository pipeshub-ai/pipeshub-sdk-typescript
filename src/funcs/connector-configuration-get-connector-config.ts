...
export function connectorConfigurationGetConnectorConfig(
  client: PipeshubCore,
  security: operations.GetConnectorConfigSecurity,
  request: operations.GetConnectorConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetConnectorConfigResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetConnectorConfigRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetConnectorConfigResponse$inboundSchema),
