...
export class Records extends ClientSDK {
   ...
   */
  async getAllRecords(
    security: operations.GetAllRecordsSecurity,
   ...
   */
  async getKBRecords(
    security: operations.GetKBRecordsSecurity,
   ...
   */
  async getKBChildren(
    security: operations.GetKBChildrenSecurity,
   ...
   */
  async getRecordById(
    security: operations.GetRecordByIdSecurity,
   ...
   */
  async deleteRecord(
    security: operations.DeleteRecordSecurity,
  ...
  async streamRecordBuffer(
    security: operations.StreamRecordBufferSecurity,
