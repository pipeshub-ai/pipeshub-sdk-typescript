 ...
 */
export function knowledgeBaseMoveRecord(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.MoveRecordRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.KnowledgeBaseMoveRecordResponse$inboundSchema),
