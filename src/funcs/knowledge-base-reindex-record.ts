 ...
 */
export function knowledgeBaseReindexRecord(
  client: PipeshubCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ReindexRecordRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReIndexRecordResponseSchema$inboundSchema),
