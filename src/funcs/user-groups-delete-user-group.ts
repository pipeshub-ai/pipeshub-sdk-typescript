...
export function userGroupsDeleteUserGroup(
  ...
  Result<
    operations.DeleteUserGroupResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteUserGroupRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/userGroups/{groupId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteUserGroupResponse$inboundSchema),
