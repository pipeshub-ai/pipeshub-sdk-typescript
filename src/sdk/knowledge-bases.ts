...
import { knowledgeBasesMoveRecord } from "../funcs/knowledge-bases-move-record.js";
import { knowledgeBasesReindexFailedRecords } from "../funcs/knowledge-bases-reindex-failed-records.js";
...
export class KnowledgeBases extends ClientSDK {
  ...
  async reindexFailedRecords(
    request: operations.ReindexFailedRecordsRequest,
    options?: RequestOptions,
  ): Promise<operations.ReindexFailedRecordsResponse> {
    return unwrapAsync(knowledgeBasesReindexFailedRecords(
      this,
      request,
      options,
    ));
  ...
  async moveRecord(
    ...
    options?: RequestOptions,
  ): Promise<operations.MoveRecordResponse> {
    return unwrapAsync(knowledgeBasesMoveRecord(
      this,
      request,
      options,
    ));
