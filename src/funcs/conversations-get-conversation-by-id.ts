...
export function conversationsGetConversationById(
  ...
  Result<
    operations.GetConversationByIdResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetConversationByIdRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetConversationByIdResponse$inboundSchema),
