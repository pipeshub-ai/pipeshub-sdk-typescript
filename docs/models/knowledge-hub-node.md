...
| `nodeType`                                                                                         | [models.NodeType](../models/node-type.md)                                                          | :heavy_check_mark:                                                                                 | Type of the node (app, recordGroup, folder, or record).                                            |
...
| `permission`                                                                                       | [models.KnowledgeHubNodePermission](../models/knowledge-hub-node-permission.md)                    | :heavy_check_mark:                                                                                 | Per-item permission when `include=permissions` is requested; otherwise `null`.                     |
