...
export function connectorControlToggleConnector(
  client: PipeshubCore,
  security: operations.ToggleConnectorSecurity,
  request: operations.ToggleConnectorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToggleConnectorResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ToggleConnectorRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToggleConnectorResponse$inboundSchema),
