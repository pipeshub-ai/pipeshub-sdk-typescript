...
export function permissionsListKBPermissions(
  client: PipeshubCore,
  security: operations.ListKBPermissionsSecurity,
  request: operations.ListKBPermissionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListKBPermissionsResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListKBPermissionsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListKBPermissionsResponse$inboundSchema),
