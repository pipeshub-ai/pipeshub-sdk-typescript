...
export class Teams extends ClientSDK {
   ...
   */
  async createTeam(
    security: operations.CreateTeamSecurity,
   ...
   */
  async listTeams(
    security: operations.ListTeamsSecurity,
   ...
   */
  async getTeamById(
    security: operations.GetTeamByIdSecurity,
   ...
   */
  async updateTeam(
    security: operations.UpdateTeamSecurity,
   ...
   */
  async deleteTeam(
    security: operations.DeleteTeamSecurity,
   ...
   */
  async getUserTeams(
    security: operations.GetUserTeamsSecurity,
