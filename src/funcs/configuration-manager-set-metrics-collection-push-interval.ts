...
export function configurationManagerSetMetricsCollectionPushInterval(
  ...
  Result<
    operations.SetMetricsCollectionPushIntervalResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetMetricsCollectionPushIntervalRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SetMetricsCollectionPushIntervalResponse$inboundSchema,
    ),
    M.fail([401, 403, "4XX"]),
    M.fail("5XX"),
  )(response, req);
