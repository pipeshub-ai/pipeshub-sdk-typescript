...
```typescript
import { AssistantStreamSSEEvent } from "@pipeshub-ai/sdk/models";

let value: AssistantStreamSSEEvent = {};
```
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `event`                                                                              | [models.AssistantStreamSSEEventEvent](../models/assistant-stream-sse-event-event.md) | :heavy_minus_sign:                                                                   | N/A                                                                                  |
